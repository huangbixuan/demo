...
public class AppUserController {
    ...
    @PreAuthenticated
    public CommonResult<String> balanceRecharge(@RequestBody @Valid AppUserRechargeVO rechargeVO) {
        String orderId = userService.balanceRecharge(getLoginUserId(), rechargeVO.getRechargeId());
    ...
    @PreAuthenticated
    public CommonResult<String> buyCard(@RequestBody @Valid AppUserCardVO userCardVO) {
        String orderId = userService.buyCard(getLoginUserId(), userCardVO.getCardId());
        return success(orderId);
    }
