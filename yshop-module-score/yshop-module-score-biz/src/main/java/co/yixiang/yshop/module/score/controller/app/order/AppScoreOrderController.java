...
public class AppScoreOrderController {
    ...
    public CommonResult<String> submit(@RequestBody @Valid AppScoreOrderParam appScoreOrderParam){
        Long uid = getLoginUserId();
        return success(appScoreOrderService.submit(uid,appScoreOrderParam));
    }
