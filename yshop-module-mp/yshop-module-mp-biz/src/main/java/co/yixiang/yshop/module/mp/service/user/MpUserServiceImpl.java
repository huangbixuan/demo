...
public class MpUserServiceImpl implements MpUserService {
    ...
    @Override
    public void addAdminNotice(Collection<Integer> ids) {
        mpUserMapper.update(new MpUserDO().setIsAdminNotice(ShopCommonEnum.YES.getValue()),
                new LambdaQueryWrapper<MpUserDO>().in(MpUserDO::getId,ids));
    }

    @Override
    public void deleteAdminNotice(Integer id) {
        mpUserMapper.update(new MpUserDO().setIsAdminNotice(ShopCommonEnum.NO.getValue()),
                new LambdaQueryWrapper<MpUserDO>().eq(MpUserDO::getId,id));
    }
