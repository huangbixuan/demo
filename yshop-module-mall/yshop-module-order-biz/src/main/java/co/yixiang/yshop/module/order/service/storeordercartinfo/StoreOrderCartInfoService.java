...
public interface StoreOrderCartInfoService extends IService<StoreOrderCartInfoDO> {
     ...
     * 添加购物车商品信息
     * @param uid 用户id
     * @param uidType user-用户 admin-员工
     * @param oid 订单id
     * @param orderId 订单号
     ...
     * @param specs 商品规格
     */
    void saveCartInfo(Long uid,String uidType,Long oid, String orderId,List<String> productIds,List<String> numbers,List<String> specs);

    /**
     * 更新餐桌信息
     * @param storeOrder 订单信息
     */
    void updateDeskInfo(StoreOrderDO storeOrder);
