...
import co.yixiang.yshop.module.order.controller.admin.storeorder.vo.ProductTopVO;
import co.yixiang.yshop.module.order.controller.admin.storeorder.vo.UserTopVO;
import lombok.Data;
...
public class OrderTimeDataDto implements Serializable {
    ...
    private List<ProductTopVO> productTopVO;

    private List<UserTopVO> userTopVO;
}
