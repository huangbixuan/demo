...
public class ExpressServiceImpl implements ExpressService {
    ...
    public Integer createExpress(ExpressCreateReqVO createReqVO) {
        ...
        expressMapper.update(ExpressDO.builder().isMain(ShopCommonEnum.DEFAULT_0.getValue()).build()
                ,new LambdaQueryWrapper<ExpressDO>().eq(ExpressDO::getType, ExpressTypeEnum.TYPE_1.getValue()));
