...
public class DemoFilter extends OncePerRequestFilter {
    ...
    protected boolean shouldNotFilter(HttpServletRequest request) {
        ...
        Boolean res22 = StrUtil.contains(path,"/admin-api/order/store-order/clearDesk");
        Boolean res222 = StrUtil.contains(path,"/admin-api/order/store-order/changeDesk");
        if(res2 || res22 || res222) {
            return true;
        }

        Boolean res224 = StrUtil.contains(path,"/admin-api/infra/file/upload");
        Boolean res225 = StrUtil.contains(path,"/admin-api/shop/material/create");
        if(res224 || res225) {
            return true;
        }
